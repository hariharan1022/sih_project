  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="kiosk-card text-center">
        ...
        <h2 className="text-3xl font-black text-white mb-2">{consentTitle}</h2>
        
        <div className="flex items-center justify-center gap-2 mb-6">
          <button
            onClick={handleReadAloud}
            className="flex items-center gap-2 px-4 py-2 bg-cyan-500/20 text-cyan-300 rounded-full border border-cyan-500/40 text-sm font-semibold hover:bg-cyan-500/30 transition-colors"
          >
        ...
        <div className="p-6 bg-slate-900/90 rounded-2xl border border-slate-700 text-left text-slate-300 text-base leading-relaxed mb-8 shadow-inner">
          <p className="mb-4 text-lg font-medium text-slate-100">{consentBody}</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 pt-4 border-t border-slate-800 text-xs text-slate-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="py-5 px-6 rounded-2xl border-2 border-rose-500/50 bg-rose-950/20 text-rose-300 font-bold text-xl kiosk-btn flex items-center justify-center gap-3 hover:bg-rose-900/30"
          >
          ...
          <button
            ...
            className="py-5 px-6 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-black text-2xl kiosk-btn shadow-xl shadow-emerald-500/20 flex items-center justify-center gap-3 hover:brightness-110"
          >
        ...
        <div className="mt-6">
          <button onClick={onBack} className="text-sm text-slate-400 underline hover:text-slate-200">
